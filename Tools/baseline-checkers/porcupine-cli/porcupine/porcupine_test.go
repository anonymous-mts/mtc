...
func TestCASJepsen000(t *testing.T) {
	CheckCASJepsen(t, 0, true)
}

func TestCASJepsen001(t *testing.T) {
	CheckCASJepsen(t, 1, false)
}

func TestCASJepsen002(t *testing.T) {
	CheckCASJepsen(t, 2, true)

}

func TestCASJepsen003(t *testing.T) {
	CheckCASJepsen(t, 3, true)
}

func TestCASJepsen004(t *testing.T) {
	CheckCASJepsen(t, 4, true)
}

func TestCASJepsen005(t *testing.T) {
	CheckCASJepsen(t, 5, true)
}

func TestCASJepsen006(t *testing.T) {
	CheckCASJepsen(t, 6, true)
}
