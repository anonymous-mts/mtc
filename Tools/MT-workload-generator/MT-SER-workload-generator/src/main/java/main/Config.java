...
public class Config {
	...
	public enum BenchType {
		CHENG, TPCC, YCSB, RUBIS, TWITTER, WRITESKEW, ROANOMALY, WOROANOMALY, MINI, GENEARAL
	};

	public enum KeyDist {
		UNIFORM, ZIPF, HOTSPOT, EXPONENTIAL
	};
	...
	public KeyDist KEY_DIST = KeyDist.UNIFORM;
	...
	// -------------General related--------------
	public int OP_PER_GENERALTXN = 4;
	/*************
	 * Sockets *
	 *************/
