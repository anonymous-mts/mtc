(ns jepsen.stolon
  ...
  (:require [clojure.tools.logging :refer [info warn] :as log]
            ...
            [jepsen [cli :as cli]
             ...
             [os :as os]
             [tests :as tests]
             [util :as util :refer [parse-long time-]]]
            ...
            ;;  [wr :as wr]
             ...
             [gen :as gen-limit]
             [nemesis :as nemesis]]
            [jepsen.stolon.gen :as gen-limit]))
...
;; (alter-var-root #'log/log* (constantly no-op-log))
