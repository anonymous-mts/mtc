...
workload = 'list-append' # 'append' or 'mini' or 'wr'
...
for max_txn_length in max_txn_length_set:
  ...
  for _ in range(test_count):
    ...
    # print(f'Round: {_ + 1}, Time: {elapsed_time}ms, Checking Time: {check_time}ms, Bug: {"N" if result.returncode == 0 else "Y"}, Abort Rate: {abort_rate:.3f}')
